...
public int convulate(int x, int y) {
  float red = 0;
  float green = 0;
  float blue = 0;
  for (int i = -1; i < 2; i++) {
...
public void keyPressed() {
  if (key == '1') {
    ...
    kernel = new float[][] { {1.0f/9.0f, 1.0f/9.0f, 1.0f/9.0f}, {1.0f/9.0f, 1.0f/9.0f, 1.0f/9.0f}, {1.0f/9.0f, 1.0f/9.0f, 1.0f/9.0f} };
  } else if (key == '3') {
...
//Identity
//kernel = new float[][] { {0, 0, 0}, {0, 1, 0}, {0, 0, 0} };
  public void settings() {  size(900, 360); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Kernel" };
    if (passedArgs != null) {
